...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (async atom-one-dark-theme bind-key dash diminish edn helm-core hydra inflections json-reformat json-snatcher multiple-cursors paredit peg pkg-info popup pos-tip projectile s seq smex spinner tagedit tide typescript-mode use-package which-key yasnippet cider clojure-mode flycheck flycheck-pos-tip less-css-mode json-mode helm-projectile helm company flycheck-clojure parinfer exec-path-from-shell epl))))
(custom-set-faces
